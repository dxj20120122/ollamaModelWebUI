...
phpstudy下载地址
    Windows：https://public.xp.cn/upgrades/phpStudy_64.zip 
    linux： Centos安装脚本 yum install -y wget & sudo wget -O install.sh https://dl.xp.cn/dl/xp/install.sh & sudo bash install.sh

        Ubuntu安装脚本 sudo wget -O install.sh https://dl.xp.cn/dl/xp/install.sh & & sudo bash install.sh

        Debian安装脚本 sudo wget -O install.sh https://dl.xp.cn/dl/xp/install.sh & sudo bash install.sh

        Mac：https://public.xp.cn/upgrades/phpstudy_install.dmg
